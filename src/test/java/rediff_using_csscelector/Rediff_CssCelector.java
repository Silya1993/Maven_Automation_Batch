package rediff_using_csscelector;
...
public class Rediff_CssCelector {
	...
	@Test(priority = 3, dependsOnMethods = {"clickOnSignInLink", "loginToRediff"},alwaysRun = true)
	public void logOut() {
	...
	@Test(priority = 4, dependsOnMethods = {"clickOnSignInLink", "loginToRediff","logOut"},alwaysRun = true)
	public void rediffHome() {

		WebElement rediffHomeLink = driver.findElement(By.cssSelector("a[class = logo]+span>a:nth-child(2)>b:nth-child(1)"));
